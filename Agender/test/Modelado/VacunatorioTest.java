...
public class VacunatorioTest {
    ...
    public void setUp() {
        ...
        solTest1 = new Solicitud("1", 20, 0, 0);
        solTest2 = new Solicitud("2", 20, 0, 0);
        solTest3 = new Solicitud("3", 20, 0, 0);
    }

    /**
     * Test del metodo agendar al recibir una persona.
     * Se espera que esta se agende en el dia 1
     */
    @Test
    ...
    /**
     * Test del metodo agendar para 1 persona
     * Se espera que su segunda dosis sea 28 dias despues
     */
    @Test
    ...
    /**
     * Test del metodo agendar para varias persona
     * Se espera que esten todas en el dia 1
     */
    @Test
    ...
    /**
     * Test del metodo agendar una vez que se llena el dia 1
     * Se espera que la persona entrante se agende el dia 2
     */
    @Test
    ...
    /**
     * Test del metodo agendar para una agenda con varios dias llenos
     * Se espera que al elegir siguiente dia para poner como dia actual,
     * la agenda omita los dias que ya se encuentran llenos
     */
    @Test
